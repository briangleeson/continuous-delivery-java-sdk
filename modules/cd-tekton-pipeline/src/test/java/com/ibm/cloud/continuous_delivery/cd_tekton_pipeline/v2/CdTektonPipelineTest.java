...
public class CdTektonPipelineTest {
  ...
  public void testGetServiceUrlForRegion() throws Throwable {
    ...
    assertEquals(CdTektonPipeline.getServiceUrlForRegion("ca-mon"), "https://api.ca-mon.devops.cloud.ibm.com/pipeline/v2");
  ...
  public void testListTektonPipelineTriggersWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"triggers\": [{\"type\": \"type\", \"name\": \"start-deploy\", \"href\": \"href\", \"event_listener\": \"eventListener\", \"id\": \"id\", \"properties\": [{\"name\": \"name\", \"value\": \"value\", \"href\": \"href\", \"enum\": [\"xEnum\"], \"type\": \"secure\", \"path\": \"path\", \"locked\": true}], \"tags\": [\"tags\"], \"worker\": {\"name\": \"name\", \"type\": \"type\", \"id\": \"id\"}, \"max_concurrent_runs\": 4, \"enabled\": true, \"favorite\": false, \"limit_waiting_runs\": false}]}";
  ...
  public void testCreateTektonPipelineTriggerWOptions() throws Throwable {
    // Register a mock response
    String mockResponseBody = "{\"type\": \"type\", \"name\": \"start-deploy\", \"href\": \"href\", \"event_listener\": \"eventListener\", \"id\": \"id\", \"properties\": [{\"name\": \"name\", \"value\": \"value\", \"href\": \"href\", \"enum\": [\"xEnum\"], \"type\": \"secure\", \"path\": \"path\", \"locked\": true}], \"tags\": [\"tags\"], \"worker\": {\"name\": \"name\", \"type\": \"type\", \"id\": \"id\"}, \"max_concurrent_runs\": 4, \"enabled\": true, \"favorite\": false, \"limit_waiting_runs\": false}";
